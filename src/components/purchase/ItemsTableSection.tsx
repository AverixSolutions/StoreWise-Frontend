...
export default function ItemsTableSection({
  ...
  return (
    <section className="col-span-9 bg-white rounded-xl shadow-lg border border-gray-200 flex flex-col h-[calc(100vh-200px)] min-h-[600px] overflow-hidden">
      {/* Header */}
      ...
      <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between flex-shrink-0 bg-gradient-to-r from-gray-50 to-gray-100/50 z-10">
        ...
        <button
          onClick={onAddRow}
          className="px-4 py-2 rounded-lg bg-averix-red-dark text-white hover:bg-averix-red-accent transition-colors flex items-center gap-2 font-medium shadow-sm hover:shadow-md z-20"
        >
