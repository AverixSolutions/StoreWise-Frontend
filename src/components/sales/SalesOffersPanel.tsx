// src/components/sales/SalesOfferPanel.tsx
"use client";
  ...
  return (
    <>
      ...
      {isOpen &&
        portalRoot &&
        createPortal(
          <div className="fixed inset-0 z-[99999] flex items-end justify-center sm:items-stretch sm:justify-end">
            <button
              type="button"
            ...
            <aside
              className="
                relative z-[100000] flex h-[88dvh] w-full flex-col overflow-hidden
                rounded-t-[26px] border border-slate-200 bg-slate-50
                shadow-[0_-18px_60px_rgba(15,23,42,0.28)]
                sm:h-full sm:max-w-md sm:rounded-none sm:border-l
                sm:shadow-[-18px_0_60px_rgba(15,23,42,0.26)]
              "
            >
