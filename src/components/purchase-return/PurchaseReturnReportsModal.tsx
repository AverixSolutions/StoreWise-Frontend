...
export default function PurchaseReturnReportsModal({
  ...
  async function confirmDelete() {
    if (!deleteId) return;
    await platform.deletePurchaseReturn?.(deleteId);
    setDeleteId(null);
    refresh();
  }
    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-slate-950/55 p-2 backdrop-blur-md sm:p-4">
      ...
      >
            ...
            <div className="flex min-w-0 items-center gap-2">
              ...
              <div className="flex min-w-0 items-center gap-2 px-1 py-1">
                ...
                <span className="hidden text-[10px] font-medium uppercase tracking-[0.14em] text-white/35 sm:inline">
                  · {total > 0 ? `${total} records` : "All purchase returns"}
                </span>
              </div>
            </div>
                        ...
                        <td className="px-4 py-1.5 text-right">
                          <div className="inline-flex items-center gap-1.5">
                            <button
                              ...
                              onClick={() =>
                                openingId ? null : onOpenPurchaseReturn(r.id)
                              }
        ...
        <Pagination
          ...
          itemLabel="purchase return records"
