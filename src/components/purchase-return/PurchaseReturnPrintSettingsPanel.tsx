...
export default function PurchaseReturnPrintSettingsPanel() {
  const [draft, setDraft] = useState<PrintDraft>(() =>
    getTaskPref("purchaseReturn"),
  );
  ...
  useEffect(() => {
    setDraft(getTaskPref("purchaseReturn"));
  }, []);
  ...
  function save(next: PrintDraft) {
    setDraft(next);
    setTaskPref("purchaseReturn", next);
  }
    ...
    <>
      <div className="space-y-3">
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-3">
          ...
          <p className="mt-0.5 text-[10px] text-slate-500">
            Both formats use the dedicated Purchase Return template.
          </p>
          <div className="mt-2 flex flex-col gap-2 sm:flex-row">
            <PaperChoice
              ...
              title="A4 Return"
              description="Professional full-page supplier return."
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-3">
            ...
            {!isDesktop ? (
              ...
              <SearchableDropdown
                ...
                menuClassName="z-[1500] max-h-56 text-xs"
                buttonProps={{ "aria-label": "Purchase Return printer" }}
              />
            )}
          </div>
        </section>
        ...
        <div className="rounded-xl border border-slate-300 bg-slate-900 px-3 py-2 text-[10px] leading-4 text-slate-100">
          <strong>Ctrl+P:</strong> prints the saved Purchase Return using these
      ...
      <SettingsOverlay
        ...
        description="Customize A4 and 80mm Purchase Return output"
        icon={LayoutTemplate}
